...
<!-- fetched_at: 2026-05-03T08:51:48.283Z -->
<!-- html_bytes: 299781 · text_chars: 19915 -->
<!-- used_by_cases: 2 -->
...
mongos > sh . getBalancerState ( ) < br > true 
...
mongos > db .adminCommand ( { removeShard : "shard0000" } ) < br > { < br > "msg" : "draining started successfully" , < br > "state" : "started" , < br > "shard" : "shard0000" , < br > "note" : "you need to drop or movePrimary these databases" , < br > "dbsToMove" : [ < br > "jumbo_t" < br > ] , < br > "ok" : 1 < br > } < br > 
...
mongos > db .chunks .find ( { "shard" : "shard0000" } , { "shard" : 1 , "jumbo" : 1 } ) .pretty ( ) < br > { < br > "_id" : "jumbo_t.col-username_-4611686018427387902" , < br > "shard" : "shard0000" , < br > "jumbo" : true < br > } 
...
mongos > sh .status ( true ) < br > < br > chunks : < br > shard0000 1 < br > shard0001 3 < br > { "username" : { "$minKey" : 1 } } -- >> { "username" : NumberLong ( "-4611686018427387902" ) } on : shard0001 Timestamp ( 3 , 0 ) < br > { "username" : NumberLong ( "-4611686018427387902" ) } -- >> { "username" : NumberLong ( 0 ) } on : shard0000 Timestamp ( 3 , 1 ) jumbo 

...
<!-- fetched_at: 2026-05-03T08:51:41.582Z -->
<!-- html_bytes: 563106 · text_chars: 16017 -->
<!-- used_by_cases: 5 -->
...
[ 1 ] If an unavailable secondary becomes available
while it still has current oplog entries, it can catch up to the
latest state of the set using the normal replication process ; otherwise, it must perform an initial sync . 

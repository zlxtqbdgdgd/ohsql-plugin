...
<!-- fetched_at: 2026-05-03T18:11:12.151Z -->
<!-- html_bytes: 781398 · text_chars: 51730 -->
<!-- used_by_cases: 21 -->
...
Platform | Architecture | Edition | 8.0 | 7.0
...
RHEL/Rocky/Alma 9 [ 6 ] | ppc64le | Enterprise | 8.0.7+ | 

RHEL/Rocky/Alma 8 [ 5 ] | ppc64le | Enterprise | ✓ | ✓

RHEL/Rocky/Alma 9 | s390x | Enterprise | 8.0.7+ | 7.0.20+

RHEL/Rocky/Alma 8 [ 5 ] | s390x | Enterprise | ✓ | ✓

[ 1 ] | ( 1 , 2 , 3 , 4 , 5 , 6 ) On Oracle Linux, MongoDB only supports the Red Hat Compatible Kernel.
Important
...
[ 8 ] | With Linux kernel versions previous to `3.5`, or RHEL / CentOS kernel versions previous to `2.6.32-303`, a `vm.swappiness` setting of `0` would still allow the kernel to swap in certain emergency situations.
Note
If your MongoDB instance is hosted on a system that also runs other

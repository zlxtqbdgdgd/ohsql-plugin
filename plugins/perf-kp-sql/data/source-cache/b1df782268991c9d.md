...
<!-- fetched_at: 2026-05-03T18:11:19.556Z -->
<!-- html_bytes: 261734 · text_chars: 14341 -->
<!-- used_by_cases: 1 -->
...
1 | eviction_trigger = 95 , eviction_target = 80
...
1 | eviction_dirty_trigger = 20 , eviction_dirty_target = 5
...
1 | eviction = ( threads_min = 4 , threads_max = 4 )
...
1 | db .adminCommand ( { "setParameter" : 1 , "wiredTigerEngineRuntimeConfig" : "eviction=(threads_min=20,threads_max=20),checkpoint=(wait=60),eviction_dirty_trigger=5,eviction_dirty_target=1,eviction_trigger=95,eviction_target=80" } )
...
1 | OPTIONS = '-f /etc/mongod.conf --wiredTigerEngineConfigString "eviction=(threads_min=20,threads_max=20),eviction_dirty_target=1"'
